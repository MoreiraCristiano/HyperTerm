...
& dotnet reportgenerator `
    ...
    '-assemblyfilters:+HyperTerm.Core;+HyperTerm.Infrastructure;+HyperTerm' `
        '-classfilters:-CompiledAvaloniaXaml.*;-System.Text.RegularExpressions.Generated*;-HyperTerm.UI.App;-HyperTerm.UI.Program;-HyperTerm.UI.Views.*;-HyperTerm.UI.Controls.WebTerminalHostControl;-HyperTerm.UI.Services.AvaloniaSystemFontService;-HyperTerm.UI.Services.AvaloniaThemeService;-HyperTerm.UI.Services.ExecutableFilePicker;-HyperTerm.UI.Services.LogInteractionService;-HyperTerm.UI.Services.SessionArchiveFilePicker;-HyperTerm.UI.Services.WindowsWebViewFocus;-HyperTerm.Infrastructure.Persistence.Migrations.*;-HyperTerm.Infrastructure.Persistence.HyperTermDbContextFactory;-HyperTerm.Infrastructure.Storage.ApplicationPathProvider;-HyperTerm.Infrastructure.Terminal.PortaPtySessionFactory;-HyperTerm.Infrastructure.Terminal.PowerShellSessionFactory;-HyperTerm.Infrastructure.Terminal.WindowsExecutableResolver;-HyperTerm.Infrastructure.Updates.UpdateJsonContext'
if ($LASTEXITCODE -ne 0) {
